...
public class ShouldDescribeEachProjectTest {
    ...
    //                        HaveAProjectCreated.called("Example Github Project")
    //                                .andConfiguredTo(
    //                                        ExecuteAShellScript.that(outputsGithubProjectLog()),
    //                                        SetBuildDescription.to("Revision: \\1")
    //                                                .basedOnLogLineMatching("Checking out Revision ([\\w]{6})")),
    ...
    //        return ShellScript.that("simulates checking out a project from github")
    //                .andOutputs(
    //                        "Started by an SCM change",
    //                        "[EnvInject] - Loading node environment variables.",
    //                        "Building remotely on 6479ff42 (lxc-fedora17 m1.small small) in workspace
    // /scratch/jenkins/workspace/metricsd",
    ...
    //                        " > git -c core.askpass=true fetch --tags --progress git@github.com:jan-molak/metricsd.git
    ...
    //                        "Checking out Revision 67f4b364e14e4282115d8e518cfe75d86e9d3f2f
