...
class ListerTest {
    ...
    @Test
    void should_return_an_empty_string_when_given_an_empty_list() {
        assertThat(Lister.asString(listOf()), is(""));
    }

    @Test
    void should_return_a_string_representation_of_a_given_object() {
        assertThat(Lister.asString(listOf("apple")), is("apple"));
    }

    @Test
    void should_use_and_instead_of_a_comma_before_the_last_item() {
        assertThat(Lister.asString(listOf("apple", "orange")), is("apple and orange"));
    }

    @Test
    void should_use_comma_to_delimit_all_the_elements_except_the_last_one() {
        assertThat(Lister.asString(listOf("apple", "orange", "banana")), is("apple, orange and banana"));
    }

    @Test
    void should_use_an_optional_template_to_describe_a_list_with_multiple_items() {
        assertThat(Lister.describe("Fruits: %s", listOf("apple", "orange")), is("Fruits: apple and orange"));
    }

    @Test
    void should_say_when_the_list_has_no_items() {
        assertThat(
    ...
    @Test
    void should_allow_to_use_a_different_template_to_describe_a_list_with_one_item() {
