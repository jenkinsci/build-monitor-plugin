...
class PluraliserTest {

    @Test
    void should_use_the_plural_format_if_no_other_is_specified() {
    ...
    @Test
    void should_use_a_singular_format_if_the_count_equals_one() {
    ...
    @Test
    void should_use_a_correct_format_depending_on_the_count_provided() {
